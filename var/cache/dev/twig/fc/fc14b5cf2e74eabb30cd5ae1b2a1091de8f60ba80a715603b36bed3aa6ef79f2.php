...
\t\t\t\t\t\t<h2>bienvenue à l'academy de Paps.</h2>
\t\t\t\t\t\t<p>Nous disposons une academie pour la formation des Papser.</p>
\t\t\t\t\t\t<p><button type=\"button\" class=\"btn btn-special\" data-toggle=\"modal\" data-target=\"#exampleModal\">S'inscription</button></p>
...
\t\t\t\t\t\t<div class=\"service\">
\t\t\t\t\t\t\t<h3><i class=\"fa fa-handshake-o\"></i>  La rencontre</h3>
\t\t\t\t\t\t\t<p>Rencontrer le candidat en personne permet de valiser ses expériences passées et ses compétences. Lors de l’échange, le candidat doit faire preuve d’honnêteté tout en mettant en avant ses qualités. Le ton de la discussion permet également d’observer et de juger si la personne correspond à ce qui est attendu.  </p>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"col-md-4 col-sm-4 service-wrap\">
\t\t\t\t\t\t<div class=\"service\">
\t\t\t\t\t\t\t<h3><i class=\"fa fa-comments-o\"></i> La discussions</h3>
\t\t\t\t\t\t\t<p>L’analyse du CV en amont de l’entretien permet de prendre connaissance des compétences du candidat. L’échange permet de déterminer si le postulant a le savoir requis pour le poste. C’est lors de ce face-à-face qu’il est possible de lui poser des questions et de s’intéresser à son savoir-faire et son savoir-être.</p>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"col-md-4 col-sm-4 service-wrap\">
\t\t\t\t\t\t<div class=\"service\">
\t\t\t\t\t\t\t<h3><i class=\"fa fa-thumbs-o-up\"></i> La validation</h3>
\t\t\t\t\t\t\t<p>Si l'entretient est réussi Paps vous contact pour venir voir l'environnement de l'entreprise, et vous serez la bienvenue chez Paps.</p>
\t\t\t\t\t\t\t<br><br><br><br>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
...
\t\t\t\t<div class=\"row row-pb-sm\">
\t\t\t\t\t<div class=\"col-md-8 col-md-offset-2 gtco-heading text-center\">
\t\t\t\t\t\t<h2>Devenir papser</h2>
\t\t\t\t\t\t<p>Suite à votre entretient Paps vous propose une fonction idéal pour le candidat.</p>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t\t<div class=\"row row-pb-md\">
...
\t\t\t\t\t\t<p>Paps, met en disposition des personnes motivés et ambitieuses.</p>
\t\t\t\t\t</div>
\t\t\t\t</div>
...
\t\t\t\t\t\t\t<div><img src=\"";
        ...
        echo "\" alt=\"Free Website template by GetTemplates.co\"></div>
\t\t\t\t\t\t\t<blockquote>
\t\t\t\t\t\t\t\t<p>&ldquo;L'équipe tech est à la pointe de l'innovation ! Nous utilisons des langages de pointe pour construire notre plateforme technologique.Nous participons régulièrement au événements les plus attendus de la scène tech.&rdquo; <cite class=\"author\">&mdash; Malik</cite></p>
\t\t\t\t\t\t\t</blockquote>\t
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
